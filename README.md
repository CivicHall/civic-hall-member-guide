# Civic Hall Member Guide

This site uses [Hugo](https://github.com/spf13/hugo), a modern framework for building websites. Hugo can be installed and run on most any system, following these [instructions](https://hugodocs.info/getting-started/installing/).  This site is built and hosted at [Netlify.com](https://www.netlify.com/)

The contents of this site's themes/civic-hall-base/src folder are used to generate CSS and javascript. You may never have to touch anything here,  unless you want to more deeply customize your styles.
